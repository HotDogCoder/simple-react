    ...
    social: [
        {
            ...
            icon: (props:any) => <i className="bx bxl-github text-2xl"></i>,
        },
        {
            name: "YouTube",
            href: "https://youtube.com/solopython",
            icon: (props:any) => <i className="bx bxl-youtube text-2xl"></i>,
        },
    ],
};
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    {/* <div className="mt-8 xl:mt-0">
                        <h3 className="text-sm font-gilroy-semibold text-gray-400 dark:text-dark-txt tracking-wider uppercase">
                            Necesitas ayuda? Help Desk te ayudara con tus dudas !
                        </h3>
                        <p className="mt-4 text-base text-gray-400">
                            Dejanos tu correo nosotros te contactaremos en menos de 24h
                        </p>
                        <form
                ...
                <div className="mt-8 border-t border-gray-200 dark:border-dark-second p-2 md:flex md:items-center md:justify-between">
                    ...
                    <small className="mt-8 text-stone-200 dark:text-stone-200 md:mt-0 md:order-1">
                        <em>&copy; 2023 acid jelly sac some rights reserved.</em>
                    </small>
                </div>
            </div>
        </footer>
